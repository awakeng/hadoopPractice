...
**추후 목표
1. Flume을 통해 데이터 적재 실습
2. 서버 활성화(spring boot)
3. 하둡 db에 있는 데이터를 export하여front에서 받아..
	1) 유저가 입력한 지역의 현재 사용 가능한 공용 주차장 출력
	2) 유저 현 위치 정보를 토대로(위도, 경도 사용) 근방 10km 내의 가용 공용 주차장 출력
